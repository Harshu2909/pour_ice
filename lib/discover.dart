...
class Discover extends StatefulWidget {
  ...
  @override
  State<Discover> createState() => _HomeState();
}

class _HomeState extends State<Discover> {
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text("Trending",style: TextStyle(fontWeight: FontWeight.bold,color: HexColor("47532F")),),
                ],
              ),
              SizedBox(height: 5,),
              Container(
